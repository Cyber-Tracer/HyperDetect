...
powershell -command "Expand-Archive -Path 'D:\FileBackup\Documents_tst.zip' -DestinationPath 'C:\Users\Client\Documents' -Force"
del /q "D:\FileBackup\Documents_tst.zip"
